  ...
  <div id="app">
    ...
    <div class="content-app theme1">
      ...
      <div class="footer">
        ...
        <p>
          <strong>HackerRank</strong> là website thực hành lập trình trực tuyến với vô vàn 
          <a href="/problem">bài tập</a>  ở đa dạng thể loại khác nhau.
          <br/>Bao gồm <a href="/problem?tag=cơ%20bản">bài tập cơ bản</a>, bài tập 
          <a href="/problem?tag=%C4%91i%E1%BB%81u%20khi%E1%BB%83n">cấu trúc điều khiển</a>, các 
          <a href="/problem?tag=vòng%20lặp">bài tập vòng lặp</a>, bài tập mảng (<a href="/problem?tag=mảng%201%20chiều">mảng 1 chiều</a>, <a href="/problem?tag=mảng%202%20chiều">mảng 2 chiều</a>, <a href="/problem?tag=chu%E1%BB%97i">bài tập chuỗi</a>), ...
        </p>
        ...
        <p> Copyright © 2020 <a href="/">HackerRank</a> &nbsp;-&nbsp; Powered by <a target="_blank" rel="nofollow noopener noreferrer" href="https://github.com/luyencode/OnlineJudgeDeploy">OnlineJudge</a></p>
      </div>
    </div>
	<BackTop></BackTop>
  </div>
